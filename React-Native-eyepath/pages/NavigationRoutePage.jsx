...
import { View, ScrollView, StyleSheet, PermissionsAndroid, Platform, Text } from 'react-native';
...
const NavigationRoutePage = ({ route }) => {
  ...
  if (errorMsg) {
    ...
    return (
      ...
      <InputFinishSection endLocation={endLocation} address={address} keyword={keyword} />
